...
GameObject game_object_cube_create(Transform transform) {
    Mesh mesh = mesh_create(CUBE_VERTEX_BUFFER_DATA, sizeof(CUBE_VERTEX_BUFFER_DATA) / sizeof(GLfloat), CUBE_UV_BUFFER_DATA, sizeof(CUBE_UV_BUFFER_DATA) / sizeof(GLfloat));
